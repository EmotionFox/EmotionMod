...
public class EmotionAchievement
{
	...
	{
		FOSSIL = (new Achievement("achievement.fossil", "fossil", -3, 0, new ItemStack(EmotionItems.FOSSIL_PICKAXE), (Achievement) null)).registerStat();
		...
		EXTEND_CAKE = (new Achievement("achievement.extendCake", "extendCake", 2, 1, new ItemStack(EmotionItems.CAKE_TOFFEE), (Achievement) null)).initIndependentStat().registerStat();
		EXTEND_PIE = (new Achievement("achievement.extendPie", "extendPie", 4, 3, new ItemStack(EmotionItems.PIE_ORANGE), EXTEND_CAKE)).registerStat();
		SWEET_JUICE = (new Achievement("achievement.sweetJuice", "sweetJuice", 6, 3, new ItemStack(EmotionItems.JUICE_CHERRY), EXTEND_PIE)).setSpecial().registerStat();
		FRUIT_TOAST = (new Achievement("achievement.fruitToast", "fruitToast", 4, 1, new ItemStack(EmotionItems.SLICE_APPLE), EXTEND_PIE)).setSpecial().registerStat();
		EXTEND_FISH = (new Achievement("achievement.extendFish", "extendFish", 0, 3, new ItemStack(EmotionItems.FISH_BASS_RAW), (Achievement) null)).initIndependentStat().registerStat();
		EXTEND_COOKED_FISH = (new Achievement("achievement.extendCookedFish", "extendCookedFish", -3, 3, new ItemStack(EmotionItems.FISH_BASS_COOKED), EXTEND_FISH)).registerStat();

		AchievementPage.registerAchievementPage(new AchievementPage("Emotion's Mod", new Achievement[]
		{ FOSSIL, MINE_PURPURA, AMULET, STAFF, PURPURA, EXTEND_CAKE, EXTEND_PIE, SWEET_JUICE, FRUIT_TOAST, EXTEND_FISH, EXTEND_COOKED_FISH }));
	}
}
