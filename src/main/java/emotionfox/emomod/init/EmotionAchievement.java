...
public class EmotionAchievement
{
	...
	public static void mainRegister()
	{
		...
		STAFF = (new Achievement("achievement.staff", "staff", 2, -4, new ItemStack(EmotionItems.STAFF_RED, 1), AMULET)).registerStat();
		...
		SWEET_JUICE = (new Achievement("achievement.sweetJuice", "sweetJuice", 6, 2, new ItemStack(EmotionItems.JUICE_CHERRY), EXTEND_PIE)).registerStat();
		FRUIT_TOAST = (new Achievement("achievement.fruitToast", "fruitToast", 4, 0, new ItemStack(EmotionItems.SLICE, 1, 3), EXTEND_PIE)).registerStat();
		...
		BUTTERFLY = (new Achievement("achievement.butterfly", "butterfly", -2, -2, new ItemStack(EmotionItems.BUTTERFLY, 1, 1), (Achievement) null)).initIndependentStat().registerStat();
