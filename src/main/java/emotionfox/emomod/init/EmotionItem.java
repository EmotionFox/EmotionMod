...
import emotionfox.emomod.item.ItemBag;
import emotionfox.emomod.item.ItemBalloon;
import emotionfox.emomod.item.ItemButterfly;
import emotionfox.emomod.item.ItemButterflyNet;
import emotionfox.emomod.item.ItemDreamStaff;
import emotionfox.emomod.item.ItemPurpuraBag;
import emotionfox.emomod.item.ItemRing;
import emotionfox.emomod.item.ItemSlice;
import emotionfox.emomod.item.ItemStaff;
import emotionfox.emomod.item.ItemViridisArmor;
import emotionfox.emomod.item.base.BaseAxe;
import emotionfox.emomod.item.base.BaseBandage;
import emotionfox.emomod.item.base.BaseBoat;
import emotionfox.emomod.item.base.BaseHoe;
import emotionfox.emomod.item.base.BaseItem;
import emotionfox.emomod.item.base.BaseJuice;
import emotionfox.emomod.item.base.BasePickaxe;
import emotionfox.emomod.item.base.BaseShovel;
import emotionfox.emomod.item.base.BaseSoup;
import emotionfox.emomod.item.base.BaseSword;
...
//		addItem(CAKE_STRAWBERRY, "cake_strawberry");
		...
		addItem(STAFF_DREAM, "staff_dream");
